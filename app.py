        ...
        async with aiohttp.ClientSession(timeout=timeout) as session:
            async with session.get(url) as res:
                ...
                try:
                    ...
                    return {"Response": "Invalid JSON response", "Price": "-", "Gateway": "-"}, site_index
...
if __name__ == '__main__':
    logger.info("Starting CC Checker Web Application on port 23000...")
    socketio.run(app, debug=True, host='0.0.0.0', port=23000)ord else f"{ip}:{port}"
